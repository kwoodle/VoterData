...
use voting;
drop table if exists `VotersCD1_24`;
CREATE TABLE `VotersCD1_24` (
...
#                            `VRSOURCE` enum('AGCY', 'CBOE', 'DMV', 'LOCALREG', 'MAIL', 'SCHOOL'),
  ...
  DEFAULT CHARSET=latin1 table_type=CSV file_name='/KWdata/Elections/CD1Voters.txt' `header`=0 `sep_char`=',' quoted=1
